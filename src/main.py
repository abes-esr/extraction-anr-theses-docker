...
EXCLUDE_KEYWORDS = [
    ...
    'table', 'sommaire', 'garde', 'planche', 'annnexe', 'annex_'
]
...
def process_chunk(chunk, chunk_start_abs):
    ...
    with open(CSV_FILE, 'w', newline='', encoding='utf-8') as csvfile:
        try:
            ...
            log(f"⚠️ Erreur dans le chunk: {str(e)}", log_file)
            ...
            with pymupdf.open(file_path) as doc:
                ...
                for page_num in range(pages_nb_to_scan):
                    ...
                    try:
                        ...
                        # Libère explicitement la page de la mémoire
                        page = None
                        gc.collect()
...
def main(log_file):
    ...
    try:
        ...
        log(f"❌ Erreur critique dans main(): {str(e)}", log_file)
        raise
